...
|---|---|---|---:|---|---|
| `tv_catalog_01_equity_like_left_skew` | success | `default` | `1.042082` | `tv_catalog_01_equity_like_left_skew__default.md` | - |
...
| `tv_catalog_05_weak_wings` | success | `default` | `1.901667` | `tv_catalog_05_weak_wings__default.md` | - |
| `tv_catalog_06_steep_upward_term_structure` | failed | - | - | - | `1` |
