...
- Objective value: `1.776589e+01`
- Inside bid/ask ratio: `90.18%`
- Bid/ask violation (max / mean): `1.423e-02` / `5.159e-04`
- MAE(mid): `1.844e-03`
- RMSE(mid): `4.400e-03`
- MAE(residual/half-spread): `0.320`
- IV total variation: `5.224e-01`
...
Le taux inside bid/ask est faible: la calibration merite un reglage des hyperparametres. Les residus normalises sont globalement contenus par rapport au demi-spread. Erreur en prix: MAE=1.844e-03, RMSE=4.400e-03. Erreur en volatilite implicite: MAE=1.183e-02, RMSE=4.570e-02. Rugosite IV (global): TV=5.224e-01, max seconde diff=5.328e+01.

## Oscillation Analysis (Before/After)
- Baseline IV smoothness (no init): TV=`3.244e-01`, max second diff=`5.328e+01`
- Current IV smoothness (linear-density init): TV=`5.224e-01`, max second diff=`5.328e+01`
- Delta (current - baseline): TV=`1.980e-01`, max second diff=`1.076e-09`
...
- T=1.000000, delta=-2.057e-11, baseline strike=0.9000, current strike=0.9000
- T=3.000000, delta=1.187e-11, baseline strike=0.7800, current strike=0.7800
- T=2.000000, delta=5.547e-10, baseline strike=0.7400, current strike=0.7400
- T=0.019178, delta=1.076e-09, baseline strike=1.0000, current strike=1.0000

## Per Maturity
| T | n_quotes | inside | bid/ask max | MAE(mid) | MAE(norm) | TV(iv) | max d2(iv) | density mass | density mean | proj? | proj L1 |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 0.019178 | 15 | 93.33% | 1.121e-03 | 1.015e-04 | 0.274 | 3.144e-01 | 5.328e+01 | 1.000000 | 1.000000 | no | 0.000e+00 |
| 0.082192 | 17 | 100.00% | 0.000e+00 | 5.137e-06 | 0.047 | 4.300e-02 | 2.573e+00 | 1.000000 | 1.000000 | no | 0.000e+00 |
| 0.246575 | 16 | 100.00% | 0.000e+00 | 3.578e-05 | 0.047 | 4.191e-02 | 1.127e+00 | 1.000000 | 1.000000 | no | 0.000e+00 |
| 0.493151 | 15 | 100.00% | 0.000e+00 | 1.149e-04 | 0.052 | 3.781e-02 | 1.249e+00 | 1.000000 | 1.000000 | no | 0.000e+00 |
| 1.000000 | 16 | 100.00% | 0.000e+00 | 3.991e-04 | 0.114 | 4.708e-02 | 7.499e-01 | 1.000000 | 1.000000 | yes | 2.829e-02 |
